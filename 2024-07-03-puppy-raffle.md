...
- [About Sami Gabor](#about-sami-gabor)
...
- [Findings](#findings)
  ...
  - [Informational OR Non-Critical](#informational-or-non-critical)
...
Smart contract developer turns to auditing

# Disclaimer

Sami Gabor makes all effort to find as many vulnerabilities in the code in the given time period, but holds no responsibilities for the the findings provided in this document. A security audit by him is not an endorsement of the underlying business or product. The audit was time-boxed and the review of the code was solely on the security aspects of the solidity implementation of the contracts.
